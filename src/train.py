...
from get_batch import vectorized_lyrics



# split into batches
x_batch, y_batch = create_batch(vectorized_lyrics, seq_length=5, batch_size=1)
...
# Checkpoint location: 
checkpoint_dir = './training_checkpoints_100_iterations'
